...
#   ('-o', 'schema/vcim/baseType.py')
#
# Command line arguments:
#   schema/vcim/base.xsd
#
# Command line:
#   ./generateDS-2.12e/generateDS.py -o "schema/vcim/baseType.py" schema/vcim/base.xsd
#
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from baseType import *\n\n')
        sys.stdout.write('import baseType as model_\n\n')
