...
#
# Generated Tue Nov  4 15:40:04 2014 by generateDS.py version 2.13a.
#
# Command line options:
#   ('-o', 'schema/vcd/v1_5/schemas/vcloud/tasksListType.py')
#
# Command line arguments:
#   schema/vcd/v1_5/schemas/vcloud/tasksList.xsd
#
# Command line:
#   ../env/bin/generateDS.py -o "schema/vcd/v1_5/schemas/vcloud/tasksListType.py" schema/vcd/v1_5/schemas/vcloud/tasksList.xsd
#
...
class TasksListType(EntityType):
    ...
    def __init__(self, VCloudExtension=None, href=None, type_=None, Link=None, operationKey=None, id=None, name=None, Description=None, Tasks=None, Task=None):
        self.original_tagname_ = None
        super(TasksListType, self).__init__(VCloudExtension, href, type_, Link, operationKey, id, name, Description, Tasks, )
        if Task is None:
            self.Task = []
        else:
            self.Task = Task
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'TasksListType'
        rootClass = TasksListType
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from tasksListType import *\n\n')
        sys.stdout.write('import tasksListType as model_\n\n')
