...
#
# Generated Tue Jan  6 09:49:26 2015 by generateDS.py version 2.14a.
#
# Command line options:
#   ('-o', 'schema/vcd/v1_5/schemas/vcloud/sessionType.py')
#
# Command line arguments:
#   schema/vcd/v1_5/schemas/vcloud/session.xsd
#
# Command line:
#   ../bin/generateDS.py -o "schema/vcd/v1_5/schemas/vcloud/sessionType.py" schema/vcd/v1_5/schemas/vcloud/session.xsd
#
...
class SessionType(ResourceType):
    ...
    subclass = None
    superclass = ResourceType
    def __init__(self, VCloudExtension=None, href=None, type_=None, Link=None, org=None, userId=None, user=None):
        self.original_tagname_ = None
        super(SessionType, self).__init__(VCloudExtension, href, type_, Link, )
